...
export function BlogFeedItem({ blog }: { blog: Blog }) {
  return (
    <article className="flex flex-col text-slate-100 min-w-full p-4 hover:bg-slate-800 group hover:cursor-pointer">
      <div className="rounded-md max-w-min p-1 hover:cursor-pointer hover:underline hover:underline-offset-4 hover:text-sky-400">
